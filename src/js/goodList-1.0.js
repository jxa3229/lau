           ...
           +'<div class="goods-info">'
             ...
             +'<div class="goods-price">'
               ...
               +'<em class="market-price" title="市场价¥'+Number(goods[i].marketPrice).toFixed(2)+'">¥'+Number(goods[i].marketPrice).toFixed(2)+'</em>'
                ...
                +'<img src="./images/star-on.png" alt="1" title="很满意">&nbsp;<img src="./images/star-on.png" alt="2" title="很满意">&nbsp;<img src="./images/star-on.png" alt="3" title="很满意">&nbsp;<img src="./images/star-on.png" alt="4" title="很满意">&nbsp;<img src="./images/star-on.png" alt="5" title="很满意"><input type="hidden" name="score" value="5" readonly="readonly"></span>'
              +'</div>'
             +'<div class="goods-sub">'
              ...
              +'</div>'
              +'<div class="add-cart">'
                    +'<a href="#" nctype="add_cart" data-param="'+goods[i].dataParam+'">'
